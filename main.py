...
def _autosign(baseLogin):
    token = baseLogin.get('https://www.gamer.com.tw/ajax/get_csrf_token.php').text
    jsoninfo = baseLogin.post('https://www.gamer.com.tw/ajax/signin.php', data={'action': '1', 'token': token})
...
def _login(data):
    ...
    account = baseLogin.post('https://api.gamer.com.tw/mobile_app/user/v3/do_login.php', data=data)
